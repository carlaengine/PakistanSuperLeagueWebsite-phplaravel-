...
CREATE TABLE `stadium` (
  `stadium_Id` int unsigned NOT NULL AUTO_INCREMENT,
  `stadium_Name` varchar(45) NOT NULL,
  `Location` varchar(45) NOT NULL,
  `Capacity` int NOT NULL,
  `pitch_Report` varchar(45) NOT NULL,
...
INSERT INTO `stadium` VALUES (1,'Sheikh Zayed Stadium','Abu Dhabi',20000,'Dry'),(2,'National Stadium','Karachi',34228,'Dry');
